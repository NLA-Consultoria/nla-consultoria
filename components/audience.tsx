...
export function Audience() {
  return (
    <section id="para-quem" className="container py-16">
      <div className="rounded-xl border-2 border-primary/60 p-6 sm:p-8 dark:border-white">
        <div className="grid gap-6 sm:grid-cols-2">
          <div>
            <h3 className="mb-4 text-center text-2xl font-semibold text-primary dark:text-white">Para quem é</h3>
          ...
          <div>
            <h3 className="mb-4 text-center text-2xl font-semibold text-primary dark:text-white">Para quem não é</h3>
            <ul className="grid gap-2">
