export const env = {
  ...
  // Clarity: aceita runtime (CLARITY_ID) ou build-time (NEXT_PUBLIC_CLARITY_ID)
  CLARITY_ID:
  ...
  META_PIXEL_ACCESS_TOKEN:
    ...
    process.env.NEXT_PUBLIC_META_PIXEL_ACCESS_TOKEN ||
    "",
};

export const hasAnalytics = () =>
  Boolean(env.GTM_ID || env.POSTHOG_KEY || env.META_PIXEL_ID);
